...
{     
    ...
    //alert(id);
    http.open('get', 'GetMonthlyReport.jsp?cmbmon='+ id+'&cmbyr='+id1);
...
<br/>
        ...
        <table align="center" class="tblform">
            <tr><td>
                 <select name="cmbmon"   class="form-control" >
                ...
                <input type="button" onclick="javascript:makeGetRequest()" value="Get Report" class="buttonStyle"/></td>                    
            </tr>
        </table>
        </form>
        <br/>
