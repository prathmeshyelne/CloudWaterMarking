...
<div class="col-md-12"> <h2> Messages (<%=request.getAttribute("username").toString().trim() %>)</h2>
 ...
 <c:forEach var="userdsc" items="${lst}">
    ...
    <c:when test="${userdsc.encsts=='on'}">
        <a href="decryptMsg1?msgId=${userdsc.msgId }&k=${userdsc.seckey }" target="_blank">Decrypt</a>
